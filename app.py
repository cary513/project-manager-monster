...
# === 直接寫入您的 Supabase 資訊（請替換成自己的）===
SUPABASE_URL = "https://mniykroryzitmxdwwali.supabase.co"   # ← 您的 URL
SUPABASE_KEY = "sb_publishable_tQ2-mcPmqFFGf96OooR4oA_pzVFOVg7"   # ← 請貼上您的 anon public key
